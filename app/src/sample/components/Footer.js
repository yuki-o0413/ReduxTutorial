                    ...
                    <div className="_fyxf74">
                        ...
                        <section className="_1l3ys1i">
                            ...
                            <ul className="_yuolfv">
                                ...
                                <li className="_wmuyow">
                                    <a href="/help/article/2701/extenuating-circumstances-policy-and-the-coronavirus-covid19" className="_o06542u">キャンセルオプション</a>
                                </li>
                                <li className="_wmuyow">
                                    <a href="/neighbors" className="_o06542u">近隣コミュニティサポート</a>
                                </li>
                                <li className="_wmuyow">
                                    <a href="/trust" className="_o06542u">信頼＆安全</a>
                                </li>
                            </ul>
                        </section>
                    </div>
                                ...
                                <div className="_3hmsj">
                                    <div className="_jro6t0">
                                        <span className="_19c5bku">
                                            <a data-no-client-routing="true" href="/account-settings/language" className="_1kejnocv">
                                                <span className="_krjbj">言語を選択</span>
                                                <span className="_bjxj6b">日本語 (JP)</span>
                                                <span className="_krjbj">通貨を選択</span>
                                                <span className="_14tkmhr">¥</span>
                                                <span className="_bjxj6b">JPY</span>
                                            </a>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="_pd8gea">
                                    <div className="_9q359r">
                                        ...
                                        <div className="_opoa3c">
                                            ...
                                            <a href="/terms" className="_o06542u">利用規約</a>
                                            <span className="_10wqwyj" aria-hidden="true">·</span>
                                            <a href="/sitemaps/v2" className="_o06542u">サイトマップ</a>
                                            <span className="_10wqwyj" aria-hidden="true">·</span>
                                            <a target="_blank" href="/about/company-details" className="_o06542u">企業情報</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
