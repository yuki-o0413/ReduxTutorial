            ...
            <header className="_1uf458w8">
                <div className="_eqf9j0">
                    <div className="_otdka">
                        ...
                        <form class="_1keztfl" action="/s/all" method="get" role="search">
                            <div class="_17fy1ix" role="tablist" aria-label="何かお探しですか？">
                            ...
                            <span id="Koan-query__description" className="_krjbj">おすすめの結果を表示するには次に進んでくださ  い</span>
